        ...
        <>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    <li class="me-2">
                    <a href="#" class="inline-flex items-center justify-center p-4 text-dark-green border-b-2 border-dark-green rounded-t-lg active dark:text-dark-green dark:border-dark-green group" aria-current="page">
                            <svg class="w-4 h-4 me-2  text-dark-green dark:text-dark-green" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
