        ...
        <>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    ...
                    <li class="/farmdashboard/products">
                        <NavLink to="/farmdashboard/products" className={({isActive}) => isActive ? "inline-flex items-center justify-center p-4 text-dark-green border-b-2 border-dark-green rounded-t-lg active dark:text-dark-green dark:border-dark-green group" : "inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group"}>
                    ...
                    <li class="/farmdashboard/orders">
                        <NavLink to="/farmdashboard/orders" className={({isActive}) => isActive ? "inline-flex items-center justify-center p-4 text-dark-green border-b-2 border-dark-green rounded-t-lg active dark:text-dark-green dark:border-dark-green group" : "inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group"}>
                            <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path className={({ isActive }) => isActive ? "text-dark-green dark:text-dark-green" : "text-gray-400 dark:text-gray-500"} d="M5 11.424V1a1 1 0 1 0-2 0v10.424a3.228 3.228 0 0 0 0 6.152V19a1 1 0 1 0 2 0v-1.424a3.228 3.228 0 0 0 0-6.152ZM19.25 14.5A3.243 3.243 0 0 0 17 11.424V1a1 1 0 0 0-2 0v10.424a3.227 3.227 0 0 0 0 6.152V19a1 1 0 1 0 2 0v-1.424a3.243 3.243 0 0 0 2.25-3.076Zm-6-9A3.243 3.243 0 0 0 11 2.424V1a1 1 0 0 0-2 0v1.424a3.228 3.228 0 0 0 0 6.152V19a1 1 0 1 0 2 0V8.576A3.243 3.243 0 0 0 13.25 5.5Z"/>
                            </svg>Orders
                        </NavLink>
                    </li>
                </ul>
